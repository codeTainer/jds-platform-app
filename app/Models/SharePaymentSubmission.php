...
class SharePaymentSubmission extends Model
{
    protected $fillable = [
        'membership_cycle_id',
        'member_id',
    ...
    public function approvedSharePurchase(): BelongsTo
    {
        return $this->belongsTo(SharePurchase::class, 'approved_share_purchase_id');
    }
